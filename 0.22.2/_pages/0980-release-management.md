...
For example: `./hack/init-next-helm-chart.sh 0.22.1 0.22.2`
...
For example `make k8s-manifests-update VERSION=0.22.2`
...
For example, to release version 0.22.2, run:
`./hack/release-helm-chart.sh 0.22.2`
