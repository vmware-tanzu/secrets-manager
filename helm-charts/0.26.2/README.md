...
3. Install VMware Secrets Manager using Helm:
    ...
    ```bash
    helm install vsecm vsecm/vsecm --version 0.26.2
    ```
...
```bash
helm install vsecm vsecm/helm-charts --version 0.26.2 \
...
|------------|------|---------|
| file://charts/keystone | keystone | 0.26.2 |
| file://charts/safe | safe | 0.26.2 |
| file://charts/sentinel | sentinel | 0.26.2 |
| file://charts/spire | spire | 0.26.2 |
