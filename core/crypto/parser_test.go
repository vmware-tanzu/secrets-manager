...
//func Test_findExpressionPos(t *testing.T) {
//	type args struct {
//		s string
//	}
//	tests := []struct {
...
//	for _, tt := range tests {
//		t.Run(tt.name, func(t *testing.T) {
//			if got := findExpressionPos(tt.args.s); !reflect.DeepEqual(got, tt.want) {
//				t.Errorf("findExpressionPos() = %v, want %v", got, tt.want)
//			}
//		})
//	}
//}
