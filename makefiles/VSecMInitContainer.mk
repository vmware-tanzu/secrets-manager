...
# Packages the “VMware Secrets Manager Init Container” binary into a container image.
init-container-bundle-ist:
	./hack/bundle.sh "vsecm-ist-init-container" \
		$(VERSION) "dockerfiles/vsecm-ist/init-container.Dockerfile"

# Packages the “VMware Secrets Manager Init Container” binary into a container image for FIPS.
...
# Packages the “VMware Secrets Manager Init Container” binary into a container image for Photon OS.
...
# Packages the “VMware Secrets Manager Init Container” binary into a container image for Photon OS and FIPS.
...
# Pushes the “VMware Secrets Manager Init Container” container image to the public registry.
init-container-push-ist:
	./hack/push.sh "vsecm-ist-init-container" \
		$(VERSION) "vsecm/vsecm-ist-init-container"

# Pushes the “VMware Secrets Manager Init Container” (FIPS) container image to the public registry.
init-container-push-ist-fips:
	./hack/push.sh "vsecm-ist-fips-init-container" \
		$(VERSION) "vsecm/vsecm-ist-fips-init-container"

# Pushes the “VMware Secrets Manager Init Container” (Photon OS) container image to the public registry.
init-container-push-photon:
	./hack/push.sh "vsecm-photon-init-container" \
		$(VERSION) "vsecm/vsecm-photon-init-container"

# Pushes the “VMware Secrets Manager Init Container” (Photon OS and FIPS) container image to the public registry.
...
# Pushes the “VMware Secrets Manager Init Container” container image to the local registry.
...
# Pushes the “VMware Secrets Manager Init Container” (Photon OS) container image to the local registry.
...
# Pushes the “VMware Secrets Manager Init Container” (Photon OS and FIPS) container image to the local registry.
